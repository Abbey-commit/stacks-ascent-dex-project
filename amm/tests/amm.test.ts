...
      // Change the sender for the mint function from 'account' to 'deployer'
      // This satisfies the 'asserts! (is-eq tx-sender contract-owner)' check in the Clarity contract.
      const mintResultOne = simnet.callPublicFn(
        "mock-token",
        "mint",
        [Cl.uint(1_000_000_000), Cl.principal(account)],
        deployer // <-- CORRECTED SENDER
      );
