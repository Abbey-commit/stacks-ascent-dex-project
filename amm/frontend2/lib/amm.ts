...
const AMM_CONTRACT_ADDRESS = "STTGMHNSGEDHMK15KY3C4TAN5NDQ1Z8FJN1YV757";
...
export async function getAllPools() {
  ...
  while (!done) {
    ...
    try {
      ...
      // Break the loop on error to prevent infinite loops
      break;
    }
  }
...
// We make the other functions following the tutorial
